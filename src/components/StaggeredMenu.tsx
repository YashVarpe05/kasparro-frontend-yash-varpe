    ...
    >
      ...
      >
        ...
        <aside
          ...
          style={{ WebkitBackdropFilter: 'blur(12px)', backgroundColor: panelBgColor, ['--panel-text-color' as string]: panelTextColor }}
          aria-hidden={!open}
        >
            ...
            >
              {items && items.length ? (
                ...
                <li className="sm-panel-itemWrap relative overflow-hidden leading-none" aria-hidden="true">
                  <span className="sm-panel-item relative font-semibold text-[4rem] cursor-pointer leading-none tracking-[-2px] uppercase transition-[background,color] duration-150 ease-linear inline-block no-underline pr-[1.4em]" style={{ color: 'var(--panel-text-color, #000)' }}>
                    <span className="sm-panel-itemLabel inline-block origin-[50%_100%] will-change-transform">
                      No items
                    </span>
                  </span>
