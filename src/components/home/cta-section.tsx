			...
			<div className="relative z-10 mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
				...
				<div className="flex flex-col sm:flex-row items-center justify-center gap-4">
					<Link href="/dashboard">
						<Button
							size="lg"
							className="gap-2 h-14 px-10 bg-violet-600 text-white hover:bg-violet-500 dark:bg-white dark:text-black dark:hover:bg-gray-100 font-semibold rounded-full text-base"
						>
							Start Free Audit
					...
					<Link href="/platform">
						<Button
							size="lg"
							variant="outline"
							className="h-14 px-10 border-foreground/20 bg-foreground/5 text-foreground hover:bg-foreground/10 dark:border-white/20 dark:bg-white/5 dark:text-white dark:hover:bg-white/10 font-semibold rounded-full text-base"
						>
							See How It Works
						</Button>
					</Link>
