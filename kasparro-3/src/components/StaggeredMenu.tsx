		...
		>
			...
			>
				...
				>
					{logoUrl && (
						<div
							className="sm-logo flex items-center select-none pointer-events-auto mr-auto"
							aria-label="Logo"
						>
							<img
								src={logoUrl}
					...
					>
						...
						>
							<span
								ref={plusHRef}
								className="sm-icon-line absolute left-1/2 top-1/2 w-full h-0.5 bg-current rounded-sm -translate-x-1/2 -translate-y-1/2 will-change-transform"
							/>
							<span
								ref={plusVRef}
								className="sm-icon-line sm-icon-line-v absolute left-1/2 top-1/2 w-full h-0.5 bg-current rounded-sm -translate-x-1/2 -translate-y-1/2 will-change-transform"
							/>
						</span>
					</button>
				</header>
				...
				<aside
					...
					style={{
						...
						["--panel-text-color" as string]: panelTextColor,
					}}
					aria-hidden={!open}
				>
								...
								items.map((it, idx) => (
									...
									>
										<a
											...
											style={{ color: "var(--panel-text-color, #000)" }}
											href={it.link}
									...
									{socialItems.map((s, i) => (
										<li key={s.label + i} className="sm-socials-item">
											<a
												...
												style={{ color: "var(--panel-text-color, #111)" }}
											>
												{s.label}
											</a>
										</li>
...
.sm-scope .sm-socials-link { font-size: 1.2rem; font-weight: 500; color: var(--panel-text-color, #111); text-decoration: none; position: relative; padding: 2px 0; display: inline-block; transition: color 0.3s ease, opacity 0.3s ease; }
.sm-scope .sm-socials-link:hover { color: var(--sm-accent, #ff0000); }
.sm-scope .sm-panel-title { margin: 0; font-size: 1rem; font-weight: 600; color: var(--panel-text-color, #fff); text-transform: uppercase; }
.sm-scope .sm-panel-list { list-style: none; margin: 0; padding: 0; display: flex; flex-direction: column; gap: 0.5rem; }
.sm-scope .sm-panel-item { position: relative; color: var(--panel-text-color, #000); font-weight: 600; font-size: 4rem; cursor: pointer; line-height: 1; letter-spacing: -2px; text-transform: uppercase; transition: background 0.25s, color 0.25s; display: inline-block; text-decoration: none; padding-right: 1.4em; }
