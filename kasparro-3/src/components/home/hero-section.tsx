					...
					<div className="flex flex-row justify-center gap-4 mb-20">
						...
						<Link href="/platform">
							<Button
								variant="outline"
								size="lg"
								className="h-12 px-8 border-foreground/20 bg-foreground/5 text-foreground hover:bg-foreground/10 hover:border-foreground/40 dark:border-white/20 dark:bg-white/5 dark:text-white dark:hover:bg-white/10 dark:hover:border-white/40 font-semibold rounded-full"
							>
								How It Works
							</Button>
						</Link>
